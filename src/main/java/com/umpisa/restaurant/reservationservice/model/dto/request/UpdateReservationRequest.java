...
public class UpdateReservationRequest {
    ...
    @Schema(description = "New reservation date and time (must be in the future)", requiredMode = Schema.RequiredMode.REQUIRED)
    ...
    @Schema(description = "New number of guests (1-50)", requiredMode = Schema.RequiredMode.REQUIRED)
