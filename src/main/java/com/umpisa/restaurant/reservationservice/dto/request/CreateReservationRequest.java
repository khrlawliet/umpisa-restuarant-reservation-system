...
public class CreateReservationRequest {
    ...
    @Schema(description = "Customer's phone number (10-15 digits, optional + prefix)", example = "+1234567890", requiredMode = Schema.RequiredMode.REQUIRED)
    ...
    @Schema(description = "Reservation date and time (must be in the future)", example = "2025-11-15T19:00:00", requiredMode = Schema.RequiredMode.REQUIRED)
    ...
    @Schema(description = "Number of guests (1-50)", example = "4", requiredMode = Schema.RequiredMode.REQUIRED)
    @NotNull(message = "Number of guests is required")
    @Min(value = 1, message = "Number of guests must be at least 1")
    @Max(value = 50, message = "Number of guests cannot exceed 50")
    private Integer numberOfGuests;

    @Schema(description = "Preferred notification channel", example = "EMAIL", requiredMode = Schema.RequiredMode.REQUIRED, allowableValues = {"EMAIL", "SMS", "BOTH"})
